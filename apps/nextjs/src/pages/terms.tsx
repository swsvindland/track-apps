    ...
    <>
      <main className="p-4">
        ...
        <p>
          ...
          PeriodTrack; etc. these terms will automatically apply to you – you
          should make sure therefore that you read them carefully before using
          the app. You’re not allowed to copy, or modify the app, any part of
          the app, or our trademarks in any way. You’re not allowed to attempt
        ...
        Except as expressly provided, Samuel Svindland makes no warranty of any
        kind, whether express, implied, statutory or otherwise. Specifically,
        Samuel Svindland hereby disclaims all implied warranties, to the maximum
        extent permitted by applicable law.
        <p></p>
        <p>
          Samuel Svindland is committed to ensuring that the app is as useful
        ...
        <p>
          The WaterTrack app stores and processes personal data that you have
          ...
          WaterTrack app won’t work properly or at all.
        </p>
        <div>
          <p>
        ...
        <p>
          You should be aware that there are certain things that Samuel
          Svindland will not take responsibility for. Certain functions of the
          ...
          but Samuel Svindland cannot take responsibility for the app not
        ...
        <p>
          Along the same lines, Samuel Svindland cannot always take
          ...
          can’t turn it on to avail the Service, Samuel Svindland cannot accept
          responsibility.
        </p>
        <p>
          With respect to Samuel Svindland’s responsibility for your use of the
          ...
          that we can make it available to you. Samuel Svindland accepts no
        ...
        <p>
          ...
          want to keep using the app. Samuel Svindland does not promise that it
        ...
        <p>
          If any provision of this Agreement is found by a proper authority to
          be unenforceable or invalid, such unenforceability or invalidity will
          not render this Agreement unenforceable or invalid as a whole; rather,
          this Agreement will be construed as if not containing the particular
          invalid or unenforceable provision or portion thereof, and the rights
          and obligations of the Parties hereto will be construed and enforced
          accordingly. In such event, the Parties will negotiate, in good faith,
          a replacement provision that would best accomplish the objectives of
        ...
        <p>
          PeriodTrack utilizes a proprietary formula for predicting period
          cycles, ovulation and fertility. However, this formula is not 100%
          accurate and may deviate from your actual period cycles, ovulation and
          fertility. These deviations can happen because of multiple reasons,
          but not limited to, stress, diet, physical activity, intimacy, birth
          control changes, or simply because your body feels like it. If you
          have any doubts about your physical health because of these
          deviations, please consult your doctor first.
        </p>
        <p>
        ...
        <p>These terms and conditions are effective as of 2020-09-14</p>
        <p>
          <strong>Contact Us</strong>
        </p>
        <p>
          If you have any questions or suggestions about my Terms and
          Conditions, do not hesitate to contact me at swsvindland@gmail.com.
        </p>
        <p>
